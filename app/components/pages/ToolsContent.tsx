  ...
  const tools = [
    {
      ...
      icon: <img src="/images/tool-logos/figma.png" alt="Figma" className="h-8 mx-auto rounded-lg" />,
    ...
    },
    {
      ...
      icon: <img src="/images/tool-logos/clickup.png" alt="Click Up" className="h-8 mx-auto rounded-lg" />,
    ...
    },
    {
      ...
      category: "Colors",
      icon: <img src="/images/tool-logos/shadergradient.png" alt="Shader Gradient" className="h-8 mx-auto rounded-lg" />,
    ...
    },
    {
      ...
      icon: <img src="/images/tool-logos/maya.png" alt="Maya" className="h-8 mx-auto rounded-lg" />,
    ...
    },
    {
      ...
      name: "Google Fonts",
      category: "Fonts",
      icon: <img src="/images/tool-logos/googlefonts.png" alt="Google Fonts" className="h-8 mx-auto rounded-lg" />,
    ...
    },
    {
      ...
      name: "Phosphor",
      category: "Icons",
      icon: <img src="/images/tool-logos/phosphor.png" alt="Phosphor" className="h-8 mx-auto rounded-lg" />,
    ...
    },
    {
      ...
      icon: <img src="/images/tool-logos/unsplash.png" alt="Unsplash" className="h-8 mx-auto rounded-lg" />,
    ...
    },
    {
      ...
      name: "Photoshop",
      category: "Graphics",
      icon: <img src="/images/tool-logos/photoshop.png" alt="Photoshop" className="h-8 mx-auto rounded-lg" />,
    ...
    },
    {
      ...
      icon: <img src="/images/tool-logos/vscode.png" alt="VS Code" className="h-8 mx-auto rounded-lg" />,
    ...
    <div className="min-h-full bg-gradient-to-b from-[#181022] to-[#241a36]">
      ...
      <div className="relative z-10 container mx-auto px-6 py-16 max-w-4xl">
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="mb-12">
          <h1 className="text-4xl font-clash-bold text-white mb-4">My Tools</h1>
